...
if __name__ == "__main__":
	...
	parser.add_argument("--html-file", required=True, help="HTML file to repeatedly validate.")
	parser.add_argument("--n", type=int, default=10, help="Number of repeat validations (default: 10).")
	parser.add_argument("--validator", default=LOCAL_VALIDATOR_URL, help="Validator endpoint URL.")
