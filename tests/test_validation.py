...
@pytest.mark.parametrize(
	...
	[
		...
		("Start tag “body” seen but an element of the same type was already open.", "duplicate-tag"),
		(
			"Element “title” not allowed as child of element “body” in this context.",
			"disallowed-child",
		),
		("Attribute “charset” not allowed on element “meta” at this point.", "disallowed-attribute"),
		(
			"Element “meta” is missing one or more of the following attributes: “content”.",
			"missing-attribute",
		),
		("Cannot recover after last error. Any further errors will be ignored.", "cannot-recover"),
...
def test_summarise_validation(tmp_path):
	data = {
		"messages": [
			...
			{"type": "info", "subType": "warning", "message": 'Consider adding lang="en"'},
